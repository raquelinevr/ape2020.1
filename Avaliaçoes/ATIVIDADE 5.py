1. Faça um programa que, para cada um dos vários alunos de uma turma, leia o
...
2. Faça um programa que leia a idade de várias pessoas visitantes de um show (a
